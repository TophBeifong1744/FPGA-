...
#
# Generated by export_simulation on Fri Jul 17 19:55:29 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './dds_2mhz.sh' script.

./dds_2mhz.sh -reset_run
...
./dds_2mhz.sh -noclean_files

For more information on the script, please type './dds_2mhz.sh -help'.
