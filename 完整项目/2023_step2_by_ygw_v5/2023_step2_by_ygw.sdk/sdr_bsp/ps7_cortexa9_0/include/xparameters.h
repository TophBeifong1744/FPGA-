...
/* Definitions for peripheral AXI_GPIO_MUX */
#define XPAR_AXI_GPIO_MUX_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_MUX_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_MUX_DEVICE_ID 0
#define XPAR_AXI_GPIO_MUX_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_MUX_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_MUX */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_MUX_DEVICE_ID
