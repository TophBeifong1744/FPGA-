...
-- Date        : Sun Jul 26 02:06:19 2026
-- Host        : Toph running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub {C:/Users/Toph
--               Beifong/Desktop/2023_step2_by_ygw_v4/2023_step2_by_ygw.srcs/sources_1/bd/design_1/ip/design_1_demod_pool_core_bpsk_0_0/design_1_demod_pool_core_bpsk_0_0_stub.vhdl}
...
entity design_1_demod_pool_core_bpsk_0_0 is
  Port ( 
    aclk : in STD_LOGIC;
    ...
    bpsk_bit_data : out STD_LOGIC;
    bpsk_bit_valid : out STD_LOGIC;
    bpsk_symbol_strobe : out STD_LOGIC;
    bpsk_nrz_out : out STD_LOGIC_VECTOR ( 15 downto 0 );
    bpsk_sample_valid : out STD_LOGIC;
    bpsk_carrier_locked : out STD_LOGIC;
    bpsk_timing_locked : out STD_LOGIC;
    bpsk_rate_code : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );

end design_1_demod_pool_core_bpsk_0_0;

architecture stub of design_1_demod_pool_core_bpsk_0_0 is
...
attribute X_CORE_INFO of stub : architecture is "demod_pool_core_bpsk,Vivado 2018.3";
begin
end;
