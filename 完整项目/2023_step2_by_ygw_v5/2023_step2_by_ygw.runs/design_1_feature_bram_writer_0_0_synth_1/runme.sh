...
HD_PWD='F:/College/verilog_digital_system/Xilinx/2023_step2_by_ygw_v5/2023_step2_by_ygw.runs/design_1_feature_bram_writer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_feature_bram_writer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_feature_bram_writer_0_0.tcl
