...
module design_1
  ...
  wire demod_pool_core_0_frame_done;
  wire [31:0]demod_pool_core_0_hist_freq_rd_data;
  wire [31:0]demod_pool_core_0_hist_mag_rd_data;
  wire [31:0]demod_pool_core_0_mean_freq_num;
  wire [31:0]demod_pool_core_0_mean_mag_num;
  wire demod_pool_core_0_psk_flag;
  wire [31:0]demod_pool_core_0_psk_spike_count;
  wire demod_pool_core_0_s_ready;
  wire [63:0]demod_pool_core_0_var_freq_num;
  wire [63:0]demod_pool_core_0_var_mag_num;
  ...
  assign ad_data_in_0_1 = ad_data_in_0[11:0];
  assign ad_otr_in_0_1 = ad_otr_in_0;
  ...
  design_1_ddc_stage1_pl2_top_0_0 ddc_stage1_pl2_top_0
       (.aclk(clk_wiz_0_clk_out2),
        ...
        .m_ready(demod_pool_core_0_s_ready),
        .m_valid(ddc_stage1_pl2_top_0_m_valid));
  design_1_demod_pool_core_0_0 demod_pool_core_0
       (.aclk(clk_wiz_0_clk_out2),
        .aresetn(rst_sample_60M_peripheral_aresetn),
        .frame_done(demod_pool_core_0_frame_done),
        .hist_freq_rd_addr(feature_bram_writer_0_hist_freq_rd_addr),
        .hist_freq_rd_data(demod_pool_core_0_hist_freq_rd_data),
        .hist_mag_rd_addr(feature_bram_writer_0_hist_mag_rd_addr),
        .hist_mag_rd_data(demod_pool_core_0_hist_mag_rd_data),
        .mean_freq_num(demod_pool_core_0_mean_freq_num),
        .mean_mag_num(demod_pool_core_0_mean_mag_num),
        .psk_flag(demod_pool_core_0_psk_flag),
        .psk_spike_count(demod_pool_core_0_psk_spike_count),
        .s_i(ddc_stage1_pl2_top_0_m_i),
        .s_q(ddc_stage1_pl2_top_0_m_q),
        .s_ready(demod_pool_core_0_s_ready),
        .s_valid(ddc_stage1_pl2_top_0_m_valid),
        .var_freq_num(demod_pool_core_0_var_freq_num),
        .var_mag_num(demod_pool_core_0_var_mag_num));
