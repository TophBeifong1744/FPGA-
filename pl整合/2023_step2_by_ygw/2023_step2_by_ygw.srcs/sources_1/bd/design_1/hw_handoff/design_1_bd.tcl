...
# module references:
# ad9226_stage1_driver, ddc_stage1_pl2_top, demod_pool_core, feature_bram_writer
...
proc create_root_design { parentCell } {
  ...
  set ad_data_in_0 [ create_bd_port -dir I -from 11 -to 0 ad_data_in_0 ]
  set ad_otr_in_0 [ create_bd_port -dir I ad_otr_in_0 ]
  ...
  # Create instance: demod_pool_core_0, and set properties
  set block_name demod_pool_core
  set block_cell_name demod_pool_core_0
  if { [catch {set demod_pool_core_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $demod_pool_core_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net ad_data_in_0_1 [get_bd_ports ad_data_in_0] [get_bd_pins ad9226_stage1_driver_0/ad_data_in]
  connect_bd_net -net ad_otr_in_0_1 [get_bd_ports ad_otr_in_0] [get_bd_pins ad9226_stage1_driver_0/ad_otr_in]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins ad9226_stage1_driver_0/clk_60m_adc] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins ad9226_stage1_driver_0/clk_60m_sample] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ddc_stage1_pl2_top_0/aclk] [get_bd_pins demod_pool_core_0/aclk] [get_bd_pins feature_bram_writer_0/aclk] [get_bd_pins rst_sample_60M/slowest_sync_clk]
  ...
  connect_bd_net -net ddc_stage1_pl2_top_0_m_i [get_bd_pins ddc_stage1_pl2_top_0/m_i] [get_bd_pins demod_pool_core_0/s_i]
  connect_bd_net -net ddc_stage1_pl2_top_0_m_q [get_bd_pins ddc_stage1_pl2_top_0/m_q] [get_bd_pins demod_pool_core_0/s_q]
  connect_bd_net -net ddc_stage1_pl2_top_0_m_valid [get_bd_pins ddc_stage1_pl2_top_0/m_valid] [get_bd_pins demod_pool_core_0/s_valid]
  connect_bd_net -net demod_pool_core_0_frame_done [get_bd_pins demod_pool_core_0/frame_done] [get_bd_pins feature_bram_writer_0/frame_done]
  connect_bd_net -net demod_pool_core_0_hist_freq_rd_data [get_bd_pins demod_pool_core_0/hist_freq_rd_data] [get_bd_pins feature_bram_writer_0/hist_freq_rd_data]
  connect_bd_net -net demod_pool_core_0_hist_mag_rd_data [get_bd_pins demod_pool_core_0/hist_mag_rd_data] [get_bd_pins feature_bram_writer_0/hist_mag_rd_data]
  connect_bd_net -net demod_pool_core_0_mean_freq_num [get_bd_pins demod_pool_core_0/mean_freq_num] [get_bd_pins feature_bram_writer_0/mean_freq_num]
  connect_bd_net -net demod_pool_core_0_mean_mag_num [get_bd_pins demod_pool_core_0/mean_mag_num] [get_bd_pins feature_bram_writer_0/mean_mag_num]
  connect_bd_net -net demod_pool_core_0_psk_flag [get_bd_pins demod_pool_core_0/psk_flag] [get_bd_pins feature_bram_writer_0/psk_flag]
  connect_bd_net -net demod_pool_core_0_psk_spike_count [get_bd_pins demod_pool_core_0/psk_spike_count] [get_bd_pins feature_bram_writer_0/psk_spike_count]
  connect_bd_net -net demod_pool_core_0_s_ready [get_bd_pins ddc_stage1_pl2_top_0/m_ready] [get_bd_pins demod_pool_core_0/s_ready]
  connect_bd_net -net demod_pool_core_0_var_freq_num [get_bd_pins demod_pool_core_0/var_freq_num] [get_bd_pins feature_bram_writer_0/var_freq_num]
  connect_bd_net -net demod_pool_core_0_var_mag_num [get_bd_pins demod_pool_core_0/var_mag_num] [get_bd_pins feature_bram_writer_0/var_mag_num]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_60M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins rst_ps7_0_60M/peripheral_aresetn]
  connect_bd_net -net rst_sample_60M_peripheral_aresetn [get_bd_pins ad9226_stage1_driver_0/resetn] [get_bd_pins ddc_stage1_pl2_top_0/aresetn] [get_bd_pins demod_pool_core_0/aresetn] [get_bd_pins feature_bram_writer_0/aresetn] [get_bd_pins rst_sample_60M/peripheral_aresetn] [get_bd_pins util_vector_logic_1/Op1]
