...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6f02.protoinst" -protoinst "protoinst_files/bd_68b9.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/xlinks/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
